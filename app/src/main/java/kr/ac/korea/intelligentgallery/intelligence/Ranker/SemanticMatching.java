...
public class SemanticMatching {
         ...
         * @since   Sigma1.0
         */
        public ContentScoreData[] getRelevantContents(ArrayList<ScoreData> arrContent2CategoryScore, int contentID) {
            int count = 0;
            ...
            try {
                ...
                for (int i = 0; i < arrContent2CategoryScore.size(); i++) {
                    ...
                    ScoreData[] b_categoryScores = this.m_graph.getTopNRelevanceCategory(arrContent2CategoryScore.get(i).getID(), 5);
